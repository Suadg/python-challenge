...
# If not, adds candidates with initial count of zero
...
# Find out who won and print it out to console
...
#------       Print the resulting analysis into a text file       ------
...
# Write the 'Election Results' and the 'Total Votes' to the txt file
...
# Write the candidates with their number of votes and the percentage of such votes
